...
public class NumbersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.v("NumbersActivity","Value at index [0]: " + words.get(0));
        Log.v("NumbersActivity","Value at index [1]: " + words.get(1));
        Log.v("NumbersActivity","Value at index [2]: " + words.get(2));
        Log.v("NumbersActivity","Value at index [3]: " + words.get(3));
        Log.v("NumbersActivity","Value at index [4]: " + words.get(4));
        Log.v("NumbersActivity","Value at index [5]: " + words.get(5));
        Log.v("NumbersActivity","Value at index [6]: " + words.get(6));
        Log.v("NumbersActivity","Value at index [7]: " + words.get(7));
        Log.v("NumbersActivity","Value at index [8]: " + words.get(8));
        Log.v("NumbersActivity","Value at index [9]: " + words.get(9));
